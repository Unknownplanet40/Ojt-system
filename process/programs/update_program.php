...
$programUuid = trim($_POST['program_uuid'] ?? '');

if (empty($programUuid)) {
    response(['status' => 'error', 'message' => 'Program UUID is required.']);
}
...
$data = [
    ...
    'required_hours' => $_POST['required_hours'] ?? 486,
    'is_active'      => $_POST['is_active'] ?? 1,
];

$result = updateProgram($conn, $programUuid, $data, $_SESSION['user_uuid']);
