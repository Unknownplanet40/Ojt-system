...
$requirements = getRequirementMap($conn, $studentUuid, $batchUuid);
$requirementsApproved = areStudentRequirementsApproved($conn, $studentUuid, $batchUuid);
...
$canApply = $requirementsApproved;
if ($application && in_array($application['status'], ['pending', 'approved', 'endorsed', 'active'], true)) {
    $canApply = false;
}
