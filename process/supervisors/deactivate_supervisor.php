...
$result = $action === 'reactivate'
    ? reactivateSupervisor($conn, $userUuid, $_SESSION['user_uuid'])
    : deactivateSupervisor($conn, $userUuid, $_SESSION['user_uuid']);
...
response([
    ...
    'message' => $action === 'reactivate'
        ? 'Supervisor account reactivated.'
        : 'Supervisor account deactivated.',
]);
