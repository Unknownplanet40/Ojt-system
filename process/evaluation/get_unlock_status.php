...
$studentUuid = $_SESSION['user_role'] === 'student'
...
response([
    'status'  => 'success',
    'midterm' => isEvaluationUnlocked($conn, $studentUuid, $batchUuid, 'midterm'),
    'final'   => isEvaluationUnlocked($conn, $studentUuid, $batchUuid, 'final'),
    'self'    => isEvaluationUnlocked($conn, $studentUuid, $batchUuid, 'self'),
]);