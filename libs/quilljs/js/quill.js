          ...
          class c extends r.BlockBlot {
            ...
            insertAt(t, e, n) {
              ...
              const r = e.split("\n"),
                i = r.shift();
              i.length > 0 &&
                (t < this.length() - 1 || null == this.children.tail ? super.insertAt(Math.min(t, this.length() - 1), i) : this.children.tail.insertAt(this.children.tail.length(), i),
                (this.cache = {}));
              let s = this;
                  ...
                  if (r)
                    if ("string" == typeof r) {
                      ...
                      this.query(i, u.Scope.INLINE)
                        ? n.push(t)
                        : (n.length() && e.push({ type: "block", delta: n, attributes: {} }), (n = new (d())()), e.push({ type: "blockEmbed", key: i, value: r[i], attributes: t.attributes ?? {} }));
                    }
                }),
                ...
                this.quill.on(r.Ay.events.EDITOR_CHANGE, (t, e, n, i) => {
                  t === r.Ay.events.SELECTION_CHANGE
                    ...
                    : t === r.Ay.events.TEXT_CHANGE &&
                      (this.ignoreChange || (this.options.userOnly && i !== r.Ay.sources.USER ? this.transform(e) : this.record(e, n)), (this.currentRange = w(this.currentRange, e)));
                }),
          ...
          class j extends x.A {
            ...
            handleNavigationShortcuts() {
              this.quill.root.addEventListener("keydown", (t) => {
                !t.defaultPrevented &&
                  ((t) => "ArrowLeft" === t.key || "ArrowRight" === t.key || "ArrowUp" === t.key || "ArrowDown" === t.key || "Home" === t.key || !(!T || "a" !== t.key || !0 !== t.ctrlKey))(t) &&
          ...
          var x = class {
            ...
            _ = class {
              ...
              handleCompositionStart(t) {
                ...
                !e ||
                  e instanceof k.A ||
                  (this.emitter.emit(N.A.events.COMPOSITION_BEFORE_START, t), this.scroll.batchStart(), this.emitter.emit(N.A.events.COMPOSITION_START, t), (this.isComposing = !0));
              }
              ...
              [
                ...
                function (t, e, n) {
                  ...
                  if (!R(t)) {
                    ...
                    ((r = r.replace(/[^\S\u00a0]/g, " ")),
                      (r = r.replace(/ {2,}/g, " ")),
                      ((null == t.previousSibling && null != t.parentElement && j(t.parentElement, n)) || (t.previousSibling instanceof Element && j(t.previousSibling, n))) &&
                        (r = r.replace(/^ /, "")),
              ...
              [
                ...
                function (t, e, n) {
                  ...
                  return i <= 0
                    ? e
                    : e.reduce(
                        (t, e) => (e.insert ? (e.attributes && "number" == typeof e.attributes.indent ? t.push(e) : t.insert(e.insert, { indent: i, ...(e.attributes || {}) })) : t),
                        new (s())(),
                      );
                },
              ],
              ...
              this.quill.root.addEventListener("keydown", (t) => {
                ...
                e.some((t) => {
                  ...
                  if (Array.isArray(t.format)) {
                    ...
                    !Object.keys(t.format).every((e) => (!0 === t.format[e] ? null != m.format[e] : !1 === t.format[e] ? null == m.format[e] : (0, r.A)(t.format[e], m.format[e])))
                  )
                    return !1;
            ...
            return {
              ...
              handler(e, n) {
                ...
                if (null != s) {
                  ...
                  const e = i.table()[r];
                  null != e &&
                    (t ? this.quill.setSelection(e.offset(this.quill.scroll) + e.length() - 1, 0, a.Ay.sources.USER) : this.quill.setSelection(e.offset(this.quill.scroll), 0, a.Ay.sources.USER));
                }
                return !1;
              },
            };
                ...
                var f = (function (t, e) {
                  ...
                  function i(t, e, n) {
                    for (var r, i, s, l, c = t.substring(n, n + Math.floor(t.length / 4)), u = -1, h = ""; -1 !== (u = e.indexOf(c, u + 1)); ) {
                      ...
                      h.length < f + d &&
                        ((h = e.substring(u - f, u) + e.substring(u, u + d)), (r = t.substring(0, n - f)), (i = t.substring(n + d)), (s = e.substring(0, u - f)), (l = e.substring(u + d)));
                    }
                    ...
                    (t[m][0] == r
                      ...
                      : (t[m][0] == n ? (v += t[m][1].length) : (A += t[m][1].length),
                        g &&
                          ...
                          (t.splice(s[o - 1], 0, [e, g]), (t[s[o - 1] + 1][0] = n), o--, (m = --o > 0 ? s[o - 1] : -1), (b = 0), (y = 0), (v = 0), (A = 0), (g = null), (i = !0))),
                      m++);
                  for (
                    i && p(t),
                      (function (t) {
                    ...
                    if (t[m - 1][0] == e && t[m][0] == n) {
                      ...
                      (E >= w
                        ...
                        : (w >= x.length / 2 || w >= N.length / 2) &&
                          (t.splice(m, 0, [r, x.substring(0, w)]), (t[m - 1][0] = n), (t[m - 1][1] = N.substring(0, N.length - w)), (t[m + 1][0] = e), (t[m + 1][1] = x.substring(w)), m++),
                        m++);
                    }
                    m++;
                  }
          ...
          function Gt(t) {
            return null != (e = t) && Vt(e.length) && !$t(e)
              ? (function (t, e) {
                  ...
                  for (var c in t)
                    (!e && !Q.call(t, c)) ||
                      (o && ("length" == c || (i && ("offset" == c || "parent" == c)) || (s && ("buffer" == c || "byteLength" == c || "byteOffset" == c)) || Ut(c, a))) ||
                      l.push(c);
                  return l;
                })(t)
              : (function (t) {
        ...
        6753: function (t, e, n) {
          ...
          var r = n(8412),
            ...
            c = function (t, e) {
              ...
              for (var g in t)
                (!e && !a.call(t, g)) ||
                  (d && ("length" == g || (u && ("offset" == g || "parent" == g)) || (h && ("buffer" == g || "byteLength" == g || "byteOffset" == g)) || (0, o.A)(g, p))) ||
                  f.push(g);
              return f;
            };
        },
                ...
                return (
                  Array.isArray(this.tagName)
                    ? ("string" == typeof t ? ((n = t.toUpperCase()), parseInt(n, 10).toString() === n && (n = parseInt(n, 10))) : "number" == typeof t && (n = t),
                      (e =
                        "number" == typeof n ? document.createElement(this.tagName[n - 1]) : n && this.tagName.indexOf(n) > -1 ? document.createElement(n) : document.createElement(this.tagName[0])))
        ...
        class wt extends yt.A {
          ...
          buildPickers(t, e) {
            ((this.pickers = Array.from(t).map((t) => {
              ...
              return (
                null == t.querySelector("option") && (t.classList.contains("ql-font") ? kt(t, xt) : t.classList.contains("ql-header") ? kt(t, Nt) : t.classList.contains("ql-size") && kt(t, Et)),
                new dt(t)
              );
            })),
          ...
          save() {
            ...
            switch (this.root.getAttribute("data-mode")) {
              case "link": {
                ...
                (this.linkRange ? (this.quill.formatText(this.linkRange, "link", t, bt.A.sources.USER), delete this.linkRange) : (this.restoreFocus(), this.quill.format("link", t, bt.A.sources.USER)),
        ...
        class Ot extends wt {
          ...
          extendToolbar(t) {
            ((this.tooltip = new St(this.quill, this.options.bounds)),
              null != t.container &&
                (this.tooltip.root.appendChild(t.container), this.buildButtons(t.container.querySelectorAll("button"), ct), this.buildPickers(t.container.querySelectorAll("select"), ct)));
          }
        }
