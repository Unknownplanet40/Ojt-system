...
<body class="login-page">
  ...
  <div class="w-100 vh-100 d-flex justify-content-center align-items-center z-1 bg-dark bg-opacity-75" id="pageLoader">
    ...
    <div class="login-panel-card card rounded-3 bg-blur-3 bg-semi-transparent w-100" style="--blur-lvl: 0.50;">
      <div class="row g-0 h-100">
        <div class="col-md-5 order-md-0 order-2">
          <div style="background-color: #0F6E56;" class="p-4 rounded-start-3 h-100 d-none d-md-block" name="login-left">
            <div class="vstack h-100">
              ...
              <div class="mt-auto">
                <div class="alert alert-dark mb-0 px-3 py-2 opacity-50" role="alert">
                  <small class="fw-bold">S.Y. </small><small
                    id="currentSchoolYear"><?= date("Y") . "-" . (date("Y") + 1) ?></span>
                    · <small
                      id="currentSemester"><?= (date("m") >= 6 && date("m") <= 11) ? "1st Semester" : "2nd Semester" ?></small></small>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-7 order-md-1 order-1">
          <div class="card-body h-100 p-4">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control rounded-2 bg-semi-transparent fw-bold" id="email"
            ...
            <div class="mb-3">
              ...
              <div class="invalid-feedback" id="passwordFeedback">Password must be at least 8 characters long and
                include uppercase, lowercase, and a number.</div>
            </div>
            <div class="d-grid mt-4">
              <button id="loginBtn" class="btn btn-outline-dark rounded-2 fw-bold text-light border-secondary" disabled>
                <span class="spinner-border spinner-border-sm me-2 d-none" id="loginSpinner" role="status"
                  aria-hidden="true"></span>
                <span class="button-text" id="loginBtnText">Sign In</span>
              </button>
            </div>
            ...
            <div class="d-grid">
              <div class="alert rounded-3 p-2 px-3 bg-dark bg-opacity-50 border-secondary">
                <div class="vstack">
                  ...
                  <small class="mb-3">Accounts are created by your OJT coordinator or system administrator. If
                    you're
                    a student or company supervisor and haven't received your login credentials yet, please contact
                    your
                    coordinator directly.</small>
                  <small class="fw-bold text-success">Administrator@school.edu.ph · +63 912 345 6789</small>
                </div>
              </div>
              <div class="alert rounded-3 p-2 px-3 bg-primary bg-opacity-25 border-secondary">
                <div class="vstack">
                  <small>First time logging in? You will be asked to set a new password after signing in with your
