...
<head>
    ...
    <script type="module" src="../../../Assets/Script/ProfileScripts/SupervisorProfileScript.js"></script>
...
<body class="admin-profile-page">
    ...
    <div class="admin-profile-main container w-100 d-flex justify-content-center align-items-center z-1">
        <div class="admin-profile-card card rounded-3 bg-blur-3 bg-semi-transparent w-100" style="--blur-lvl: <?= $opacitylvl ?>;">
            <div class="card-body">
                <small class="text-muted" id="backToDashboardLink"><a href="./SupervisorDashboard" class="text-decoration-none text-muted">&larr; Back</a></small>
                <div class="hstack mb-4">
                    <small class="fw-bold"><?= $LongTitle ?> <span
                            class="badge bg-info bg-opacity-50 text-info-emphasis rounded-pill px-2 fw-medium">Supervisor</span></small>
                ...
                <div class="alert alert-info mb-3 rounded-3 py-2 border-0" role="alert">
                    <small class="mb-0" id="profileInfoText">Set up your supervisor profile. Students and coordinators will see this information.</small>
                </div>
                <div class="card bg-semi-transparent mb-3" style="--blur-lvl: <?= $opacitylvl ?>;">
                    <div class="card-body p-3 px-4">
                        <div class="vstack">
                            <small class="fw-medium">Supervisor information</small>
                            <span class="text-muted"><small id="adminInfoStatus">Basic details for your supervisor account.</small></span>
                        </div>
                        <div class="hstack">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-4 fname-group">
                            ...
                            <div class="col-md-4 lname-group">
                                <small for="lastName" class="form-label">Last Name <span
                                        class="text-danger">*</span></small>
                                <input type="text" class="form-control form-control-sm bg-semi-transparent"
                                    id="lastName" placeholder="Enter your last name">
                            </div>
                            <div class="col-md-4 position-group">
                                <small for="position" class="form-label">Position <span
                                        class="text-danger">*</span></small>
                                <input type="text" class="form-control form-control-sm bg-semi-transparent"
                            ...
                            <div class="col-md-4 contactNumber-group">
                ...
                <div class="text-center">
                    <small class="text-muted"><a href="#" id="startTourLink">Take a tour of the profile setup</a></small>
                </div>
            </div>
        </div>
    </div>
