        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content bg-blur-5 bg-semi-transparent border-0 shadow" style="--blur-lvl: 0.7">
                <div class="modal-body p-4">
                    ...
                    <small class="text-muted d-block mt-3" style="font-size: 0.875rem;">Type <strong id="closeBatchNameConfirm">CLOSE</strong> in the box below to
                        confirm.</small>
                    <input type="text"
                ...
                <div class="modal-footer border-0 d-flex justify-content-center">
                    <div class="hstack gap-2">
                        <button type="button" class="btn btn-sm btn-outline-light py-2 px-3 rounded-3 flex-grow-1" id="cancelCloseBatchBtn"
                            data-bs-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-sm btn-danger py-2 px-3 rounded-3 flex-grow-1" id="confirmCloseBatchBtn" disabled>Yes, Close
                            Batch</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content bg-blur-5 bg-semi-transparent border-0 shadow" style="--blur-lvl: 0.7">
                <div class="modal-body p-4">
                    ...
                    <small class="mb-0 text-muted ps-2">You are about to set <strong id="batchToActivateName">N/A</strong>. as the active batch.</small>
                    <span class="bg-warning text-warning-emphasis bg-opacity-25 rounded-3 d-inline-block mt-3 p-2"
                        style="font-size: 0.875rem;">
                        This will automatically close the current active batch (<span id="currentActiveBatchName">N/A</span>). Students in
                        the current batch will no longer be able to submit new DTR or journal entries.
                    </span>
                </div>
                <div class="modal-footer border-0 d-flex justify-content-center">
                    <div class="hstack gap-2">
                        <button type="button" class="btn btn-sm btn-outline-light py-2 px-3 rounded-3 flex-grow-1" id="cancelActivateBatchBtn"
                            data-bs-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-sm btn-success py-2 px-3 rounded-3 flex-grow-1" id="confirmActivateBatchBtn">Yes,
                            Activate</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card bg-blur-5 bg-semi-transparent border border-muted shadow-sm"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-1 row-cols-md-2 g-2 d-flex mt-2">
                                ...
                                <div class="col">
                                    <small class="text-muted mt-1 d-block text-uppercase" style="font-size: 0.65rem;">Default OJT hours</small>
                                    <label for="schoolYearInput" class="form-label" style="font-size: 0.875rem;">Required Hours <span class="text-danger">*</span></label>
                                    <input type="number" min="0"
                                        class="form-control bg-blur-5 bg-semi-transparent shadow-sm text-white"
                                        id="requiredHoursInput" placeholder="e.g. 486" style="--blur-lvl: 0.5">
                                    <small class="text-muted d-block" style="font-size: 0.70rem;">CHED standard is 486 hrs — programs can override this</small>
                                </div>
                                <div class="col">
                                    <label for="schoolYearInput" class="form-label" style="font-size: 0.875rem;">Activate Imimediately?</label>
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input shadow-none" type="checkbox" id="activateImmediatelySwitch">
                                        <label class="form-check-label" for="activateImmediatelySwitch" style="font-size: 0.875rem;">Yes, set this as the active batch immediately after creation.</label>
                                    </div>
                                </div>
                            </div>
                            <div class="hstack d-flex justify-content-end mt-4">
                                <button class="btn btn-sm btn-outline-dark border text-light py-2 px-3 rounded-3" data-bs-dismiss="modal" id="cancelNewBatchBtn">Cancel</button>
                                <button class="btn btn-sm btn-outline-light py-2 px-3 rounded-3 ms-2" id="saveNewBatchBtn">Create Batch</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down modal-lg">
            <div class="modal-content bg-blur-5 bg-semi-transparent border-0 shadow" style="--blur-lvl: 0.6">
                <div class="modal-body p-4">
                    ...
                    <small class="mb-0 text-muted ps-2 mt-0">Modify the details of this batch. You can also choose to activate it immediately from here.</small>
                    <div class="alert alert-warning py-1 my-3" role="alert">
                        <small>Editing a batch will not affect existing student records, but changes to the semester dates may affect when students can submit DTR and journal entries.</small>
                    </div>
                    ...
                    <div class="card bg-blur-5 bg-semi-transparent border border-muted shadow-sm"
                        ...
                        <div class="card-body">
                            <p class="card-title fw-medium mb-0">Semester details</p>
                            <small class="text-muted mb-3">This will group all students, applications, and OJT records for this period.</small>
                            <div class="row row-cols-1 row-cols-md-2 g-2 d-flex mt-2">
                                <div class="col">
                                    <label for="EditschoolYearInput" class="form-label" style="font-size: 0.875rem;">School
                                        Year <span class="text-danger">*</span></label>
                                    <input type="text"
                                        class="form-control bg-blur-5 bg-semi-transparent shadow-sm text-white"
                                ...
                                <div class="col">
                                    <label for="EditsemesterInput" class="form-label" style="font-size: 0.875rem;">Semester
                                        <span class="text-danger">*</span></label>
                                    <select id="EditsemesterInput"
                                        class="form-select bg-blur-5 bg-semi-transparent shadow-sm text-white"
                                        style="--blur-lvl: 0.5">
                                        <option value="" selected disabled hidden class="bg-blur-5 bg-semi-transparent text-muted">Select semester</option>
                                        <option value="1st" class="CustomOption">1st Semester</option>
                                        <option value="2nd" class="CustomOption">2nd Semester</option>
                                        <option value="summer" class="CustomOption">Summer</option>
                                    </select>
                                ...
                                <div class="col">
                                    <label for="EditstartDateInput" class="form-label" style="font-size: 0.875rem;">Start
                                        Date <span class="text-danger">*</span></label>
                                    <input type="date"
                                        class="form-control bg-blur-5 bg-semi-transparent shadow-sm text-white"
                                ...
                                <div class="col">
                                    <small class="text-muted mt-1 d-block text-uppercase" style="font-size: 0.65rem;">Default OJT hours</small>
                                    <label for="EditrequiredHoursInput" class="form-label" style="font-size: 0.875rem;">Required Hours <span class="text-danger">*</span></label>
                                    <input type="number" min="0"
                                        class="form-control bg-blur-5 bg-semi-transparent shadow-sm text-white"
                                ...
                                <div class="col">
                                    <label for="EditactivateImmediatelySwitch" class="form-label" style="font-size: 0.875rem;">Activate Immediately?</label>
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input shadow-none" type="checkbox" id="EditactivateImmediatelySwitch">
                                        <label class="form-check-label" for="EditactivateImmediatelySwitch" style="font-size: 0.875rem;">Yes, set this as the active batch immediately after creation.</label>
                                    </div>
                                </div>
                            </div>
                            <div class="hstack d-flex justify-content-end mt-4">
                                <button class="btn btn-sm btn-outline-dark border text-light py-2 px-3 rounded-3" data-bs-dismiss="modal" id="cancelEditBatchBtn">Cancel</button>
                                <button class="btn btn-sm btn-outline-light py-2 px-3 rounded-3 ms-2" id="saveEditBatchBtn">Save Changes</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="d-flex flex-nowrap z-3 min-vh-100" id="PageMainContent">
        <main class="d-flex flex-column flex-grow-1 overflow-auto">
            ...
            <div class="container-fluid p-4 w-100" id="dashboardContent">
                ...
                <p class="text-success me-2 mb-0" id="activeBatchLabel"></span></p>
                <div class="container my-4 p-0">
                    <div class="row row-cols-1 row-cols-md-1 g-4 d-flex" id="batchesContainer">
                        <?php for ($i = 0; $i < 10; $i++) : ?>
                        <div class="col">
                            <div class="card h-100 bg-blur-5 bg-semi-transparent rounded-4 shadow-sm <?= $i === 0 ? 'border-success border-2' : '' ?>"
                                style="--blur-lvl: 0.60">
                                <div class="card-body py-3 px-4">
                                    <div class="hstack">
                                        <p class="card-title mb-0 fw-bold">AY 2025–2026 · 1st
                                            Semester</p>
                                        <span
                                            class="badge bg-white text-success rounded-pill ms-auto fw-medium <?php echo $i === 0 ? 'd-block' : 'd-none' ?>">Active</span>
                                        <span
                                            class="badge bg-dark text-muted rounded-pill ms-auto fw-medium border <?php echo $i !== 0 ? 'd-block' : 'd-none' ?>">Upcoming</span>
                                    </div>
                                    <small class="text-muted" style="font-size: 0.875rem;">Jun 1, 2025 — Oct 31,
                                        2025</small>
                                    <div class="row row-cols-md-4 g-3 mt-2">
                                        <div class="col">
                                            <div class="card bg-blur-5 bg-semi-transparent shadow-sm border-0 h-100">
                                                <div class="card-body p-2">
                                                    <p class="card-title mb-0 text-muted" style="font-size: .75rem;">
                                                        Students</p>
                                                    <h6 class="card-subtitle mt-1 mb-0 text-muted">120</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card bg-blur-5 bg-semi-transparent shadow-sm border-0 h-100">
                                                <div class="card-body p-2">
                                                    <p class="card-title mb-0 text-muted" style="font-size: .75rem;">
                                                        Required Hours</p>
                                                    <h6 class="card-subtitle mt-1 mb-0 text-muted">486</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card bg-blur-5 bg-semi-transparent shadow-sm border-0 h-100">
                                                <div class="card-body p-2">
                                                    <p class="card-title mb-0 text-muted" style="font-size: .75rem;">
                                                        Activated</p>
                                                    <h6 class="card-subtitle mt-1 mb-0 text-muted">June 1, 2025</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card bg-blur-5 bg-semi-transparent shadow-sm border-0 h-100">
                                                <div class="card-body p-2">
                                                    <p class="card-title mb-0 text-muted" style="font-size: .75rem;">
                                                        Created</p>
                                                    <h6 class="card-subtitle mt-1 mb-0 text-muted">Ryan S.</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <hr class="my-2">
                                    <div class="hstack">
                                        <span class="text-muted" style="font-size: 0.80rem;">Created Jun 1, 2025</span>
                                        <div
                                            class="gap-2 ms-auto <?php echo $i === 0 ? 'd-block' : 'd-none' ?>">
                                            <button
                                                class="btn btn-sm btn-outline-dark text-white border border-light px-3 rounded-2">
