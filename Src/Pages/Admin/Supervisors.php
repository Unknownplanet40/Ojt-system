                        ...
                        <div class="mb-4">
                            <div class="hstack gap-3 align-items-center">
                                <div class="vstack gap-1">
                                    <h5 class="modal-title fw-bold mb-0 fs-5">Add Supervisor</h5>
                                    <p class="text-muted small mb-0">Create a new supervisor account for a company partner.</p>
                                </div>
                                <button type="button" class="btn btn-sm btn-outline-secondary ms-auto flex-shrink-0" data-bs-dismiss="modal"><i class="bi bi-arrow-left me-2"></i>Back</button>
                            </div>
                        </div>

                        <div class="card bg-transparent rounded-4 border-0 mb-4" style="--blur-lvl: <?= $opacitylvl ?>;">
                                ...
                                <div class="d-flex align-items-start gap-3 mb-3">
                                    ...
                                    <div class="flex-grow-1 min-w-0">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            <span class="badge rounded-pill bg-secondary-subtle text-body border">Temporary password auto-generated</span>
                                            <span class="badge rounded-pill bg-secondary-subtle text-body border">Required fields marked with <span class="text-danger">*</span></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-floating border-bottom">
                                            <select class="form-select bg-transparent border-0 shadow-none" id="supervisorCompany">
                                                <option value="" class="CustomOption" selected hidden>Choose company</option>
                                            </select>
                                            <label for="supervisorCompany" class="text-muted">Company<span class="text-danger ms-1">*</span></label>
                                        </div><small class="text-muted d-block mt-2"><i class="bi bi-info-circle me-1"></i>Green highlighted companies already have supervisors assigned</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-content bg-blur-5 bg-semi-transparent border-0 shadow" style="--blur-lvl: <?= $opacitylvl ?>;">
                    <div class="modal-body p-4 p-md-5">
                        <div class="mb-4">
                            <div class="hstack gap-3 align-items-center">
                                <div class="vstack gap-1">
                                    <h5 class="modal-title fw-bold mb-0 fs-5">Edit Supervisor</h5>
                    ...
                    <div class="modal-body p-4 p-md-5">
                        <div class="vstack gap-3 mb-3">
                            <div class="hstack gap-3 align-items-center w-100">
                                <img src="https://placehold.co/64x64/483a0f/c6983d/png?text=SV&font=poppins" alt="Profile Picture" class="rounded-circle border" id="viewSupervisorProfilePic" style="width:72px;height:72px;object-fit:cover;">
                                <div class="min-w-0">
                                    <h5 class="mb-0 fw-bold" id="viewSupervisorFullName"></h5>
                                    <p class="text-muted small mb-0"><span id="viewSupervisorCompany"></span> &bull; <span id="viewSupervisorEmail"></span></p>
                                </div>
                                <button type="button" class="btn btn-sm btn-outline-secondary ms-auto flex-shrink-0" data-bs-dismiss="modal"><i class="bi bi-arrow-left me-2"></i>Back</button>
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-12 col-lg-7">
                                <div class="card bg-transparent rounded-4 border shadow-sm h-100" style="--blur-lvl: <?= $opacitylvl ?>;">
                                    <div class="card-body p-4 p-lg-4 bg-transparent">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <h6 class="fw-bold mb-0">Supervisor Details</h6>
                                            <small class="text-muted">Read-only summary</small>
                                        </div>
                                        <div class="row g-3">
                                            <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 col-lg-5">
                                <div class="card bg-transparent rounded-4 border shadow-sm h-100 supervisor-panel" style="--blur-lvl: <?= $opacitylvl ?>;">
                                    <div class="card-body p-4 p-lg-4 d-flex flex-column bg-transparent">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <h6 class="fw-bold mb-0">Quick Actions</h6>
                                            <span class="small text-muted">Manage account</span>
                                        </div>
                                        <div class="vstack gap-2 mt-1">
                                            <button class="btn btn-sm border rounded-3 p-2 quickactions" id="exportViewSupervisorPdfBtn">
                                                <i class="bi bi-file-earmark-pdf me-2"></i>Export Details PDF
                                            </button>
                                            <button class="btn btn-sm border rounded-3 p-2 quickactions" id="editSupervisorFromViewBtn"><i class="bi bi-pencil-square me-2"></i>Edit Details</button>
                                            <button class="btn btn-sm border rounded-3 p-2 quickactions" id="resetSupervisorPasswordBtn"><i class="bi bi-key me-2"></i>Reset Password</button>
                                            <button class="btn btn-sm border border-danger rounded-3 p-2 quickactions" id="deactivateSupervisorBtn"><i class="bi bi-person-x me-2"></i>Deactivate Account</button>
                                            <button class="btn btn-sm border border-success rounded-3 p-2 quickactions d-none" id="activateSupervisorBtn"><i class="bi bi-person-check me-2"></i>Reactivate Account</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
